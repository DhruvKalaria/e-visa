            ...
            >
              <slide>
                <div class="carousel-caption">
                  <h4  style="backdrop-filter: blur(10px); background-color: black;">
...
export default {
  ...
  data() {
    return {
      classicModal: false,
      selectedDate: new Date("2022/05/16"),
      carousel1: require("@/assets/img/islamabad-pakistan.jpg"),
      carousel2: require("@/assets/img/delhi-india.jpg"),
      carousel3: require("@/assets/img/madrid-spain.jpg")
    };
  },
  methods: {
    classicModalHide() {
