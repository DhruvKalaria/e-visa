  ...
  <div class="wrapper">
    ...
    <div id="inputs">
      ...
      <div class="md-layout text-center">
        <div
          class="md-layout-item md-size-80 md-xsmall-size-80 md-small-size-50 md-medium-size-40"
        >
          <md-field>
            <md-input v-model="initial" placeholder="Enter Tracking Number..."></md-input>
          </md-field>
        </div>
    ...
    <div class="md-layout-item md-size-33 mx-auto mt-auto mr-auto text-center">
      <md-button class="md-success" @click="classicModal = true">Track number</md-button>
